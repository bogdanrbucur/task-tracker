...
interface TaskCancelledEmailProps {
			...
			<Tailwind>
				...
				<Body className="bg-white my-auto mx-auto font-sans px-2">
					<Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] max-w-[465px]">
						...
						<Section>
							<Heading className="text-black text-[24px] font-normal text-center p-0 my-[30px] mx-0">Task cancelled</Heading>
							<Text className="text-black text-[14px] leading-[24px]">Hello {task.assignedToUser?.firstName},</Text>
							<Text className="text-black text-[14px] leading-[24px]">
								A task that was pending with you was cancelled by {userFirstName} {userLastName}:
								<p>
							...
							<Text className="text-black text-[14px] leading-[24px]">
								<strong>Cancel comment:</strong> {comment}
							</Text>
						</Section>
						<Text>You may still view the task details.</Text>
...
export default TaskCancelledEmail;
